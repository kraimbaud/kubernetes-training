...
### Core Concepts [:memo: (Exercices)](exercises/1.core.md)
...
### Configuration [:memo: (Exercices)](exercises/2.configuration.md)
- [ConfigMaps](https://kubernetes.io/docs/concepts/configuration/configmap/)
- [Secrets](https://kubernetes.io/docs/concepts/configuration/secret/)
- [Configure Service Accounts for Pods](https://kubernetes.io/docs/tasks/configure-pod-container/configure-service-account/)

### State Persistence [:memo: (Exercices)](exercises/3.persistence.md)
...
### POD Design & Application Lifecycle Management
